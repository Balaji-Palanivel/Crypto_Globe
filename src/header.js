  ...
  render() {
    return (
      <div style={{ position: "relative" }}>
        <div className="row bg-dark text-light py-2 justify-content-end">
              ...
              <tr>
                <td>
                  <div className="text-center fs-1 pb-2 ">
                    ...
                    <i
                      data-test="fa"
                      className="sc-gSAPjG vdkON fa fa-globe"
                    ></i>
                    Globe
                  </div>
                </td>
                <td>
                  <div className="menu_1 col-sm-2">
                    <i
                      data-test="fa"
                      data-bs-toggle="offcanvas"
                      data-bs-target="#offcanvasTop"
                      aria-controls="offcanvasTop"
                      className="sc-gSAPjG vdkON fa fa-bars fs-4"
                    ></i>
                  </div>
                </td>
              </tr>
          ...
          <div
            class="xyz offcanvas offcanvas-top bg-dark"
            tabindex="-1"
            id="offcanvasTop"
